...
public class ThirdViewUtil {
    ...
    public static View convertAutoView(String name, Context context, AttributeSet attrs) {
        ...
        View view = null;
        if (name.equals(ActivityDelegate.Companion.getACTIVITY_DELEGATE())) {
            view = new AutoFrameLayout(context, attrs);
        } else if (name.equals(ActivityDelegate.Companion.getLAYOUT_LINEARLAYOUT())) {
            view = new AutoLinearLayout(context, attrs);
        } else if (name.equals(ActivityDelegate.Companion.getLAYOUT_RELATIVELAYOUT())) {
